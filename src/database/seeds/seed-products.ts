...
export async function seedProducts(
  ...
  const p2 = productsRepository.create({
    ...
    price: 5100,
    stockQuantity: 10,
    imageUrl: 'https://bizweb.dktcdn.net/100/444/581/products/1-jpeg-82ff66f9-3112-4142-a1ec-9515781ecbf9.jpg?v=1656323109783',
    ram: '8GB',
    cpu: 'Apple M1',
    card: 'Apple M1 GPU',
    chip: 'Apple M1 Chip',
  ...
  const p3 = productsRepository.create({
    ...
    price: 5200,
    stockQuantity: 10,
    imageUrl: 'https://tse2.mm.bing.net/th?id=OIP.tFzJeqA6Oa9DAeYXmY_L0wHaHa&pid=Api&P=0&h=180',
    ram: '8GB',
    cpu: 'Apple M1',
    card: 'Apple M1 GPU',
    chip: 'Apple M1 Chip',
  ...
  const p4 = productsRepository.create({
    ...
    price: 5300,
    stockQuantity: 10,
    imageUrl: 'https://tse2.mm.bing.net/th?id=OIP.XlofPo8jwWzBY9fad4y9CgHaHa&pid=Api&P=0&h=180',
    ram: '16GB',
    cpu: 'Apple M1',
    card: 'Apple M1 GPU',
    chip: 'Apple M1 Chip',
  ...
  const p6 = productsRepository.create({
    ...
    price: 5500,
    stockQuantity: 10,
    imageUrl: 'https://tse1.mm.bing.net/th?id=OIP.TzhgK1fRrlyrvpb0nrGP4wHaHa&pid=Api&P=0&h=180',
    ram: '16GB',
    cpu: 'Apple M1',
    card: 'Apple M1 GPU',
    chip: 'Apple M1 Chip',
  ...
  const p8 = productsRepository.create({
    ...
    price: 5700,
    stockQuantity: 10,
    imageUrl: 'http://cdn.mos.cms.futurecdn.net/YmkgfXJZPhKHx3r4tr5ZoC.jpg',
    ram: '32GB',
    cpu: 'Apple M1',
    card: 'Apple M1 GPU',
    chip: 'Apple M1 Chip',
  ...
  const p9 = productsRepository.create({
    ...
    price: 5800,
    stockQuantity: 10,
    imageUrl: 'https://tse4.mm.bing.net/th?id=OIP.vSaIq8LpxvA38QEfMiJVzQHaDk&pid=Api&P=0&h=180',
    ram: '32GB',
    cpu: 'Apple M1',
    card: 'Apple M1 GPU',
    chip: 'Apple M1 Chip',
  ...
  const p10 = productsRepository.create({
    ...
    price: 5900,
    stockQuantity: 10,
    imageUrl: 'https://tse1.mm.bing.net/th?id=OIP.-_nkYJsfcfec4foklF6bmAHaFs&pid=Api&P=0&h=180',
    ram: '32GB',
    cpu: 'Apple M1',
    card: 'Apple M1 GPU',
    chip: 'Apple M1 Chip',
